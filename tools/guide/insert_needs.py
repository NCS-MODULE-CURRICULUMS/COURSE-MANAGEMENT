...
"m15": ([("작업지시서", "배포 시나리오와 제출 형식이 여기 있습니다"),
         ("EX01 프로젝트", "소스 · 테스트 · <b>스크립트 골격</b>이 들어 있고 "
                          "채울 자리가 <b>일곱</b> 입니다"),
         ("JDK 17 이상 · Gradle", "Gradle 은 프로젝트의 <b>래퍼</b>를 쓰므로 "
                                 "따로 깔지 않아도 됩니다"),
         ("운영 흉내를 낼 폴더", "<code>releases/</code> 와 <code>deploy/</code> 를 "
                               "만들 수 있는 자리면 됩니다")],
        "프로젝트가 없어도 <b>배포 시나리오와 소프트웨어 목록(실습 4)</b> 은 먼저 쓸 수 있습니다"),
